<%@ Page Title="" Language="C#" MasterPageFile="~/Currentstudent.master" AutoEventWireup="true" CodeFile="studenthome.aspx.cs" Inherits="studenthome" %>
...
<td></td>
<td align="left" height="40" width="70"><asp:Label ID="Label10" runat="server" Text="Year"></asp:Label></td>
<td height="40"></td>
<td height="40"><asp:TextBox ID="txtyear" runat="server"></asp:TextBox></td>
</tr>
